...
syn keyword suevFunction	parameter tension gravity constraint boundary optimizing_parameter gravity_constant quantity define  printf  QUANTITY CONSTRAINT BOUNDARY PARAMETER TENSION DEFINE constraints
